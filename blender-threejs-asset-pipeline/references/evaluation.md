...
General invariants are explicit artifact contracts, faithful corner attributes, supported-input honesty, coherent revisions and resource ownership. Specific UV channel numbers, texture codecs, atlas sizes and project mesh names are not universal defaults. Compression/performance tradeoffs belong to [performance](../../threejs-performance/SKILL.md); transport and filtering belong to [baked GI](../../blender-threejs-baked-gi/SKILL.md).
