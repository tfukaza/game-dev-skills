...
Use [asset delivery](../blender-threejs-asset-pipeline/SKILL.md) for source/export correctness and ownership, [GI](../blender-threejs-baked-gi/SKILL.md) for baking, and [scene QA](../threejs-scene-qa/SKILL.md) for visual acceptance.
