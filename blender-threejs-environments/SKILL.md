...
| Work | Skill |
|---|---|
| Map, terrain, architecture placement, collision | [Layout](../blender-threejs-layout/SKILL.md) |
| Reference isolation, modeling, lettering, variants, foliage | [Props](../blender-threejs-props/SKILL.md) |
| Repeating PBR and anti-repetition sampling | [Materials](../blender-threejs-materials/SKILL.md) |
| Contextual wear, deposits, repairs, local markings | [Surface paint](../blender-threejs-surface-paint/SKILL.md) |
...
| CPU/GPU/loading/memory bottlenecks | [Performance](../threejs-performance/SKILL.md) |
| Reference, traversal, defect isolation, final checks | [Scene QA](../threejs-scene-qa/SKILL.md) |
