...
- Use [asset pipeline](../../pipeline/blender-threejs-asset-pipeline/SKILL.md) when exporting or comparing Blender/runtime artifacts.
- Use [scene QA](../../validation/threejs-scene-qa/SKILL.md) for broader visual and interaction verification; use [performance](../../validation/threejs-performance/SKILL.md) for measured runtime cost.
