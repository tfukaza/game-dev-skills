...
See [KTX2Loader](https://threejs.org/docs/pages/KTX2Loader.html) for capability detection and worker limits; use [asset delivery](../../../pipeline/blender-threejs-asset-pipeline/SKILL.md) for lifecycle correctness. Inventory estimates payload storage, not total driver memory.
