...
For frame-time and memory claims use [performance](../threejs-performance/SKILL.md), which owns measurement tools. For GLB/UV preservation use [asset pipeline](../blender-threejs-asset-pipeline/SKILL.md). Never equate mocked lifecycle tests, a screenshot or a low draw count with complete acceptance.
